...
export class ConfigurationService {
  ...
  getAuthorizationService() {
    return {
      cookieExpirySeconds: this.configService.get<number>(
  ...
  getAuth0() {
    return {
      auth0: {
        ...
        nonInteractiveClientId: this.configService.get<string>(
          'AUTH0_NONINTERACTIVE_ID',
          '',
        ),
        nonInteractiveClientSecret: this.configService.get<string>(
      ...
      auth0New: {
        ...
        nonInteractiveClientId: this.configService.get<string>(
          'AUTH0_NEW_NONINTERACTIVE_ID',
          '',
        ),
        nonInteractiveClientSecret: this.configService.get<string>(
          'AUTH0_NEW_NONINTERACTIVE_ID_SECRET',
          '',
        ),
      },
    };
